...
if (dayNumber >= 1 && dayNumber <= 10) {
    console.log(`Число ${dayNumber} попадает в 1-ю декаду месяца.`);
} else if (dayNumber >= 11 && dayNumber <= 20) {
    console.log(`Число ${dayNumber} попадает во 2-ю декаду месяца.`);
} else if (dayNumber >= 21 && dayNumber <= 31) {
    console.log(`Число ${dayNumber} попадает в 3-ю декаду месяца.`);
} else {
