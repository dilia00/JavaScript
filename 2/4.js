...
const num = Number.parseInt(prompt('Введите целое положительное число:'));
const units = num % 10;
const tens = num % 100 / 10;
const hundreds = num % 1000 / 100;
console.log(`В числе ${num} количество сотен: ${Math.floor(hundreds)}, десятков: ${Math.floor(tens)}, единиц: ${units}`);
